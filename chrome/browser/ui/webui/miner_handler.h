...
#ifndef CHROME_BROWSER_UI_WEBUI_MINER_HANDLER_H_
#define CHROME_BROWSER_UI_WEBUI_MINER_HANDLER_H_
...
class MinerHandler : public content::WebUIMessageHandler,
                       public LoginUIService::Observer {
 public:
  explicit MinerHandler(content::WebUI* web_ui);
  ~MinerHandler() override;
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(MinerHandler);
};

#endif  // CHROME_BROWSER_UI_WEBUI_MINER_HANDLER_H_
